...
RELATIVE_OCR_EXPORT_DIR = '/../ocr_model/'

def main(_):
  print('loading...')

  data_dir = os.path.dirname(os.path.realpath(__file__)) + '/../ocr/'
...
if __name__ == '__main__':
  ...
  parser.add_argument(
        '--log_dir',
        type=str,
        default=os.path.join(os.getenv('TEST_TMPDIR', '/tmp'), 'pacman/ocr/logs/'),
        help='Summaries log directory')
  parser.add_argument(
        '--export_dir',
        type=str,
        default=os.path.dirname(os.path.realpath(__file__)) + RELATIVE_OCR_EXPORT_DIR,
